...
/**
 * @file
 * Contains the theme settings form for Open Framework.
 */

/**
 * Implements hook_form_system_theme_settings_alter().
 *
 * @see open_framework_settings_validate()
 * @see open_framework_settings_submit()
 */
 ...
 $form['background_container']['body_bg_classes'] = array(
  ...
  if (!empty($body_bg_path)) {
    $form['background_container']['body_bg_preview'] = array(
      '#theme' => 'image',
      '#path' => theme_get_setting('body_bg_path'),
    );
  }
...
/**
 * Form validation handler for open_framework_form_system_theme_settings_alter().
 *
 * @see open_framework_settings_submit()
 */
function open_framework_settings_validate($form, &$form_state) {
  ...
  // @todo The file is saved in both validate and submit. Pick one, or document
  //   why a duplicate save is needed.
...
/**
 * Form submission handler for open_framework_form_system_theme_settings_alter().
 *
 * @see open_framework_settings_validate()
 */
function open_framework_settings_submit($form, &$form_state) {
  ...
  if ($file) {
    ...
    if (file_copy($file, $destination, FILE_EXISTS_REPLACE)) {
      // @todo $_POST should not be modified directly during form submission.
